...
class Warehouse extends CRMEntity {
	...
	var $table_name = 'vtiger_warehouse';
	var $table_index= 'warehouseid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_warehousecf', 'warehouseid');
	// Uncomment the line below to support custom field columns on related lists
	// var $related_tables = Array('vtiger_warehousecf'=>array('warehouseid','vtiger_warehouse', 'warehouseid'));

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_warehouse', 'vtiger_warehousecf');
	...
	function getQueryByModuleField($module, $fieldname, $srcrecord, $query='') {
		...
		if($module == 'Invoice' || $module == 'PurchaseOrder' || $module == 'Quotes' || $module == 'SalesOrder') {
			$query1 = $query_body ." WHERE (vtiger_warehouse.warehno <> 'Purchase' and vtiger_warehouse.warehno <> 'Sale') and " . $query_cond;
			return $query1;
		}
		elseif($module == 'Movement'){
			switch ($fieldname) {
				case 'srcwhid':
					$query1 = $query_body ." WHERE vtiger_warehouse.warehno <> 'Sale' and " . $query_cond;
					return $query1;
					break;
				case 'dstwhid':
					$query1 = $query_body ." WHERE vtiger_warehouse.warehno <> 'Purchase' and " . $query_cond;
					return $query1;
					break;
				default:
